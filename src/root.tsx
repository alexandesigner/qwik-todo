    ...
    return onRender$(() => {
      console.log(
        'on:qRender => <Item item="' +
          JSON.stringify(props.item, (key, value) =>
      ...
      return (
        <Host
          class={{ completed: props.item.completed, editing: state.editing }}
        >
          <div class="view">
            <input
              class="toggle"
            ...
            <button
              class="destroy"
              on$:click={() => removeItem(props.todos, props.item)}
            ></button>
          </div>
          {state.editing ? (
            <input
            ...
            <>
              ...
              {remaining > 0 ? (
                <button
                  ...
                  on$:click={() => clearCompleted(props.todos)}
                >
                  Clear completed
                </button>
              ) : null}
